...
### 2. Integrity of Disclaimer — Anti-Removal

2.1 **Prohibition of removal.** No User may remove, delete, conceal, obscure, truncate, or otherwise impair the visibility or discoverability of this disclaimer from the Project or any Derivative. This prohibition applies to the disclaimer in its entirety and to any individual provision thereof.

2.2 **Constructive notice — survival irrespective of physical presence.** The binding force of this disclaimer does not depend on its physical presence in any particular copy of the Project or Derivative. Even if this disclaimer has been removed, deleted, or concealed from a copy — whether by the User or by any upstream distributor — all terms of this disclaimer continue to bind every User of that copy with full force. Removal of the disclaimer text does not constitute, create, or imply lack of notice, ignorance, or waiver of any kind.

2.3 **Willful violation.** Any act of removing, deleting, concealing, or materially altering this disclaimer with intent to evade its terms constitutes a willful and knowing violation of this disclaimer. Such conduct shall be deemed conclusive evidence that the User had actual knowledge of the disclaimer's existence and content, voluntarily chose to breach it, and acted in bad faith. No User may assert ignorance of this disclaimer as a defense where the disclaimer has been removed or concealed by that User or by anyone acting in concert with or at the direction of that User.

2.4 **Tampering with content.** No User may modify, rewrite, paraphrase, abridge, or translate this disclaimer in a manner that materially alters, weakens, narrows, or nullifies any of its terms, obligations, or protections. Any such modified version is void and of no effect; the original disclaimer as published by the Project maintainers in the original Project repository shall govern exclusively.

2.5 **Verification duty of downstream recipients.** Any person who obtains the Project or a Derivative through a source other than the original Project repository (`https://github.com/LING71671/eni-reverselab-platform`) has an affirmative duty to verify whether this disclaimer governs the work. The absence of a visible disclaimer in a received copy does not relieve the recipient of the obligation to locate, read, and comply with the disclaimer as published in the original Project repository. Ignorance resulting from the upstream removal or concealment of the disclaimer is not a defense.

2.6 **No waiver through inaction.** Failure by the Project authors, contributors, or maintainers to enforce any provision of this disclaimer against any User does not constitute a waiver of the right to enforce that provision against that User or any other User, whether in relation to the same or different circumstances.

### 3. Legal Compliance — All Jurisdictions

3.1 The Project and all Derivatives must be used in strict compliance with **all** applicable laws, regulations, rules, and regulatory requirements of every jurisdiction involved, including but not limited to:
...
3.2 The User is solely responsible for determining which laws apply and for obtaining all necessary licenses, permits, authorizations, and legal advice before using the Project.

3.3 **No geographic exception exists.** The fact that the Project is accessible from a particular country or region does not constitute a representation that use in that country or region is lawful. The User must independently verify lawfulness.

### 4. Authorized Purposes Only

4.1 The Project is provided **exclusively** for the following purposes:
...
4.2 **Authorization must be specific, written, and prior.** Implied, retrospective, or verbal authorization is insufficient. The User bears the burden of proving authorization was obtained.

4.3 Any use outside the purposes enumerated in 4.1 is unauthorized and prohibited.

### 5. Prohibited Uses

5.1 The User must **not** use the Project or any Derivative for any of the following:
...
5.2 This list is non-exhaustive. The absence of a specific activity from this list does not imply authorization.

### 6. No Warranty

6.1 THE PROJECT IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, NON-INFRINGEMENT, ACCURACY, COMPLETENESS, SECURITY, AVAILABILITY, OR FREEDOM FROM DEFECTS OR VULNERABILITIES.

6.2 The Project authors, contributors, and maintainers do not warrant that the Project is error-free, secure, legally compliant, or suitable for any particular purpose. The User assumes all risk associated with the use of the Project.
...
7.2 **The User agrees to indemnify, defend, and hold harmless** the Project authors, contributors, and maintainers from and against any and all claims, demands, suits, proceedings, liabilities, damages, losses, costs, and expenses (including reasonable legal fees) arising from or related to the User's use, misuse, or distribution of the Project or any Derivative, or the User's violation of this disclaimer or any applicable law.

### 8. Derivative Works

8.1 **Mandatory retention and integrity.** Any Derivative must include this disclaimer in its entirety, in a prominent and easily discoverable location (at minimum: the root README or equivalent primary documentation file). The disclaimer must be reproduced verbatim, without any modification, deletion, abridgement, paraphrasing, translation, reformatting, or rearrangement that affects its substantive meaning. This retention obligation is absolute and survives any and all modifications to other parts of the Project or Derivative — no change to the Project, however extensive, extinguishes the duty to retain the disclaimer intact. Any Derivative that removes, conceals, or materially alters this disclaimer is in material breach of this agreement, and all Users of such Derivative remain fully bound by the original disclaimer as published in the original Project repository, notwithstanding its removal or alteration from that Derivative.

8.2 **Attribution.** Any Derivative must clearly and conspicuously state its relationship to the Project, including a link to the original Project repository (`https://github.com/LING71671/eni-reverselab-platform`) and a statement that the Derivative is not endorsed by or affiliated with the Project authors.

8.3 **No dilution.** The creation or distribution of a Derivative does not exempt the Derivative's author, distributor, or users from any provision of this disclaimer. All provisions apply to Derivatives with the same force as to the original Project.

8.4 **Sub-licensing.** Any license grant for a Derivative must be consistent with and not purport to override, narrow, or invalidate any provision of this disclaimer.

8.5 **Notification duty.** Any person who distributes the Project or a Derivative to a third party must take reasonable steps to bring this disclaimer to the attention of the recipient before or at the time of distribution.

8.6 **Removal of the disclaimer from a Derivative constitutes an independent breach** of this agreement by the person who performed the removal, and such person assumes direct and personal liability for any damages, claims, or losses arising from any downstream User's reliance on the absence of the disclaimer. The person who removed the disclaimer bears the burden of proving that any downstream User had independent knowledge of the disclaimer's terms.
...
### 16. Unauthorized Distribution & Impersonation

16.1 **Compromised or malicious copies.** Any person who forks, modifies, or redistributes a copy of the Project that introduces code, behavior, or functionality not present in the original — including backdoors, malware, spyware, trackers, miners, or any other malicious payload — does so at their own risk and on their own behalf. The Project authors bear no responsibility for the safety, integrity, or authenticity of any copy obtained from any source other than the original Project repository (`https://github.com/LING71671/eni-reverselab-platform`). The presence of the Project's name or attribution in a compromised copy does not constitute the Project authors' endorsement of or responsibility for that copy. Users are strongly urged to verify copies against the official repository before use. GPL-3.0 does not impose upon the Project authors any obligation to monitor, audit, or approve third-party modifications.

16.2 **Service wrappers (SaaS / API).** Any third party that wraps, hosts, or provides the Project or any Derivative as a service — including SaaS platforms, API services, "as-a-service" offerings, cloud-hosted instances, or any form of remote or automated delivery of the Project's functionality — does so as an independent actor. Such service provision does not create any agency, partnership, or other relationship between the service provider and the Project authors. The service provider is solely responsible for: lawful operation in all jurisdictions; vetting and monitoring its users; responding to abuse reports and legal demands; and any harm or liability arising from the service. No claim against the Project authors may be based on the conduct of an independent third-party service that incorporates or wraps the Project.

16.3 **Third-party content (tutorials, videos, etc.).** Any third party that creates or publishes content — including tutorials, videos, livestreams, articles, courses, training materials, or social media posts — that features, references, demonstrates, or incorporates the Project (collectively, "Third-Party Content") does so on its own initiative. Such content reflects the views and judgments of its creator alone. The Project authors do not endorse or verify any Third-Party Content, are not responsible for the accuracy, legality, safety, or ethics of any instruction or demonstration therein, and are not responsible for any act taken by a viewer in reliance on such content, even if the content identifies the Project or its authors as a source. The inclusion of the Project's name in Third-Party Content does not constitute the Project authors' participation in or complicity in any act depicted or enabled by that content.

16.4 **AI/ML training and model use.** The Project's source code, knowledge base, documentation, scripts, and any other content (collectively, "Project Content") may be used by third parties as input or training data for artificial intelligence, machine learning, or large language model systems (collectively, "AI Systems"). Any AI System trained on, fine-tuned with, or otherwise incorporating Project Content is an independent product of its creator or operator. The Project authors: (a) do not authorize, endorse, or review the use of Project Content in AI training; (b) make no representation about the correctness, safety, lawfulness, or ethical compliance of any output, advice, or action generated or recommended by such AI Systems; (c) are not responsible for any harm, damage, or liability arising from any person's use of or reliance on such AI Systems, regardless of whether the AI System or its operator identifies the Project or its authors as a source of training data; (d) are not responsible for any act taken by a User of such AI Systems in reliance on the AI System's output, even where that output reproduces, paraphrases, or derives from Project Content. The inclusion of Project Content in AI training does not convert the Project authors into co-authors, co-developers, or co-operators of the resulting AI System.
