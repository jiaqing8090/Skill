...
```text
你是我的 ReverseLab 安装助手。请在我的电脑上完成 eni-reverselab-platform 的首次安装、检查和交付，要求如下：

目标：
1. 如果我还没有仓库，请把 https://github.com/LING71671/eni-reverselab-platform.git 克隆到一个稳定目录，例如 <workspace>/eni-reverselab-platform。
2. 如果我已经有仓库，请直接使用现有的 eni-reverselab-platform 文件夹，不要重复克隆。
