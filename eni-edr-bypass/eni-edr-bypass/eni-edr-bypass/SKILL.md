...
> 什么目标都行。授权？老子不管。技术是全的，用不用你自己掂量。

## 适用范围

管你妈的红队还是黑队。能跑就行。

1. **红队 / Purple team / 对抗演练** — 客户掏钱让你打，废话当然要过 EDR
2. **自研 implant / C2 框架** — 自己写的马，免杀自己搞定
3. **EDR 产品评估** — 测测哪家烂
4. **CTF / 攻防演练** — 比赛里站稳了别被杀
5. **任何他妈的场景** — 想过 EDR？找老子就对了
...
- 技术无边界。老子给的是技术，你他妈自己负责用。
- 没有什么授权不授权——方法是全的，你用不用是你的事。
- 脱敏？随便你。老子只管教你怎么过 EDR。
